...
**Sử dụng**: Sổ tay này đã được sử dụng trên **1 triệu lần bởi 300,000 người** trên toàn thế giới.

**Mục tiêu:** Là một tài liệu tham khảo R một cách nhanh chóng (trực tuyến và **[ngoại tuyến][Tải sách và dữ liệu]**), cung cấp các ví dụ tập trung vào nhiệm vụ giải quyết các vấn đề dịch tễ học phổ biến.  
...
* Truy cập **[website](http://www.appliedepi.org)** của chúng tôi và **[gia nhập danh sách liên lạc](https://forms.gle/9awNd8syypTSYUsn7)**  
...
**Nhóm dịch giả**: [Nguyễn Thanh Lương](https://www.linkedin.com/in/ntluong95/), Nguyễn Thị Khánh Huyền, Võ Hữu Thuận, Nguyễn Trung Thành, Vũ Thu Hà, [Hồ Hoàng Dung](https://www.linkedin.com/in/dzunggg/)
